...
public class TestClient {
    ...
    private static final String CONFIG_FILE = initConfigFile();

    public static final Config CONFIG = Config.create(ConfigSources.classpath(CONFIG_FILE));
    ...
    private static String initConfigFile() {
        return System.getProperty(CONFIG_PROPERTY_NAME, DEFAULT_CONFIG_FILE);
    }
    ...
    public static class Builder {
        ...
        Builder() {
            this.host = "localhost";
            this.port = CONFIG.get("server.port").as(Integer.class).get();
        }
